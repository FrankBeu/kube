...
func NewMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v2:Mapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMapping(ctx *pulumi.Context,
	...
	var resource Mapping
	err := ctx.ReadResource("kubernetes:getambassador.io/v2:Mapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
