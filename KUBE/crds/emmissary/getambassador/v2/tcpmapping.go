...
func NewTCPMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v2:TCPMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTCPMapping(ctx *pulumi.Context,
	...
	var resource TCPMapping
	err := ctx.ReadResource("kubernetes:getambassador.io/v2:TCPMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
