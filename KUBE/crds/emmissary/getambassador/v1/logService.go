...
func NewLogService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:LogService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogService(ctx *pulumi.Context,
	...
	var resource LogService
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:LogService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
