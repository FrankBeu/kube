...
func NewKubernetesServiceResolver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:KubernetesServiceResolver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesServiceResolver(ctx *pulumi.Context,
	...
	var resource KubernetesServiceResolver
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:KubernetesServiceResolver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
