...
func NewModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:Module", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModule(ctx *pulumi.Context,
	...
	var resource Module
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:Module", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
