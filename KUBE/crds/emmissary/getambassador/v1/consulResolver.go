...
func NewConsulResolver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:ConsulResolver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsulResolver(ctx *pulumi.Context,
	...
	var resource ConsulResolver
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:ConsulResolver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
