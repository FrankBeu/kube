...
func NewTLSContext(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:TLSContext", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTLSContext(ctx *pulumi.Context,
	...
	var resource TLSContext
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:TLSContext", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
