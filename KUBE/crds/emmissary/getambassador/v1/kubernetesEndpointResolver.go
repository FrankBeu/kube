...
func NewKubernetesEndpointResolver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:KubernetesEndpointResolver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubernetesEndpointResolver(ctx *pulumi.Context,
	...
	var resource KubernetesEndpointResolver
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:KubernetesEndpointResolver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
