...
func NewTracingService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:getambassador.io/v1:TracingService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTracingService(ctx *pulumi.Context,
	...
	var resource TracingService
	err := ctx.ReadResource("kubernetes:getambassador.io/v1:TracingService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
